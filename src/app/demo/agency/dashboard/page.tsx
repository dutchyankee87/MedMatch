...
export default function DemoAgencyDashboardPage() {
  return (
    <div className="flex flex-col h-full">
      <Header title="Dashboard" subtitle="Demo weergave" />
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <Button variant="outline" asChild>
              <Link href="/demo/agency/requests">
            ...
            <CardContent>
              <div className="space-y-3">
                {openRequests.map((request) => (
                  <div
                    key={request.id}
                    className="block p-3 rounded-lg bg-gray-50"
                  >
